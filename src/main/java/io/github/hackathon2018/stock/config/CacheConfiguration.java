package io.github.hackathon2018.stock.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(io.github.hackathon2018.stock.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(io.github.hackathon2018.stock.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            ...
            cm.createCache(io.github.hackathon2018.stock.domain.Performers.class.getName(), jcacheConfiguration);
            cm.createCache(io.github.hackathon2018.stock.domain.Request.class.getName() + ".performers", jcacheConfiguration);
