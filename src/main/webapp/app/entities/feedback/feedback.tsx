    ...
    return (
      <div>
        <h2 id="feedback-heading">
          <Translate contentKey="jhipsterApp.feedback.home.title">Feedbacks</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterApp.feedback.home.createLabel">Create new Feedback</Translate>
          </Link>
        </h2>
