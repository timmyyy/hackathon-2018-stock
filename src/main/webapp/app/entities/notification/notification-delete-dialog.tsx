  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterApp.notification.delete.question">
          <Translate contentKey="jhipsterApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
