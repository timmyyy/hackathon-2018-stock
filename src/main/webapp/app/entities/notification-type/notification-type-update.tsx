    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterApp.notificationType.home.createOrEditLabel">
              <Translate contentKey="jhipsterApp.notificationType.home.createOrEditLabel">Create or edit a NotificationType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
                ...
                <AvGroup>
                  ...
                  >
                    <option value="NEW_REQUEST">
                      <Translate contentKey="jhipsterApp.NotificationTypeCode.NEW_REQUEST" />
                    </option>
                    <option value="NEW_RESPONSE">
                      <Translate contentKey="jhipsterApp.NotificationTypeCode.NEW_RESPONSE" />
                    </option>
                    <option value="YOU_ARE_THE_CHOSEN_ONE">
                      <Translate contentKey="jhipsterApp.NotificationTypeCode.YOU_ARE_THE_CHOSEN_ONE" />
                    </option>
                    <option value="REQUEST_CONFIRMED">
                      <Translate contentKey="jhipsterApp.NotificationTypeCode.REQUEST_CONFIRMED" />
                    </option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
