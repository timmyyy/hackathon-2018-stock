...
public class NotificationResourceIntTest {
    ...
    public void createNotification() throws Exception {
        ...
        assertThat(testNotification.getCreateTime()).isEqualTo(DEFAULT_CREATE_TIME);
        assertThat(testNotification.isReaded()).isEqualTo(DEFAULT_READED);
    }
    ...
    public void updateNotification() throws Exception {
        ...
        Notification testNotification = notificationList.get(notificationList.size() - 1);
        assertThat(testNotification.getCreateTime()).isEqualTo(UPDATED_CREATE_TIME);
        assertThat(testNotification.isReaded()).isEqualTo(UPDATED_READED);
    }
